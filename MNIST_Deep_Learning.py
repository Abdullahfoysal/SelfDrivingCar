...
assert(X_train.shape[1:] == (28,28)), "The dimentions of the images are not 28*28"
assert(X_test.shape[1:] == (28,28)), "The dimentions of the images are not 28*28"
num_of_samples = []
cols =5
num_classes = 10
...
for i in range(cols):
  for j in range(num_classes):
    ...
    axs[j][i].axis("off")
    if i==2:
      axs[j][i].set_title(str(j)+"("+str(len(x_selected))+")")
...
#Normalize pixel value of image range[0,1]
X_train = X_train/255
X_test = X_test/255
